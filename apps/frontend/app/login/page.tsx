...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050505] px-4 font-sans selection:bg-white/30 selection:text-white">
      {/* Background Glows */}
      ...
      <div className="relative z-10 w-full max-w-md animate-[fade-in-up_0.8s_ease-out_both]">
        ...
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-black/40 p-8 backdrop-blur-xl shadow-2xl shadow-black/50">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              className="group relative mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-white px-4 py-3 text-sm font-medium text-black transition-all hover:bg-white/90 disabled:opacity-50 disabled:hover:bg-white"
              disabled={loading}
              type="submit"
            >
              {loading ? (
