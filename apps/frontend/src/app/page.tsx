...
export default function Home() {
  ...
  return (
    <div
      ref={containerRef}
      style={{ background: "#0A0F0D", minHeight: "100vh", overflowX: "hidden" }}
    >
      <LandingNav />
      ...
      >
        {/* Hero background — nocturnal landscape */}
        <div
          style={{
            position: "absolute",
            inset: 0,
            ...
            {scrambleWords.map((word, wi) => (
              ...
              >
                {word.split("").map((char, ci) => {
                  ...
                  // biome-ignore lint/suspicious/noArrayIndexKey: static word scramble
                  return (
                    <div
                ...
                {Array.from({ length: Math.max(0, 8 - word.length) }).map(
                  (_, fi) => {
                    // biome-ignore lint/suspicious/noArrayIndexKey: static word scramble fill
                    return (
                      <div
